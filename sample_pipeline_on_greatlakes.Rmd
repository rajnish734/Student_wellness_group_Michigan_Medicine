...
hr_60 <- hr_60 %>%
  mutate(
    MSR_DT = as.Date(STUDY_METRIC_MSR_START_DT),
    MSR_TIME = format(STUDY_METRIC_MSR_START_DT, "%H:%M:%S")
  )
...
hr_60$MSR_TIME_POSIXct <- as.POSIXct(paste(hr_60$MSR_DT, hr_60$MSR_TIME))
```
